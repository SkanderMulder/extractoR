...
**instructoR** is an R package that automatically validates and corrects LLM outputs against your schema. Inspired by Python's [instructor](https://github.com/jxnl/instructor) and [outlines](https://github.com/outlines-dev/outlines), it eliminates the pain of malformed JSON and schema violations through intelligent self-correction.
...
- **Rich Schema Support**: Enums, nested objects, arrays, and complex structures
...
instructoR excels at extracting structured information from various domains:
...
instructoR works with any LLM supported by [ellmer](https://github.com/hadley/ellmer):
