---
title: "Getting Started with extractoR"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with extractoR}
...
extractoR is a package for extracting structured data from unstructured text using Large Language Models (LLMs). It automatically validates LLM responses against your schema and retries with intelligent feedback until the output is valid.
...
extractoR handles all of this automatically:
...
extractoR supports rich schema definitions that map naturally to R types.
...
extractoR offers three strategies for providing feedback when validation fails.
...
extractoR supports local LLMs through Ollama, enabling:
...
- [extractoR (R)](https://github.com/SkanderMulder/extractoR) for similar functionality
